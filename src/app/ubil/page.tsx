               ...
               <Card className="glass-panel border-white/5 shadow-2xl flex flex-col min-h-[400px]">
                <CardHeader className="p-4 md:p-6 border-b border-white/5 flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div className="relative w-full md:w-64">
                    ...
                    <Input placeholder="Filter Nodes..." className="pl-9 h-8 bg-secondary/30 border-white/5 text-[10px] rounded-lg" value={search} onChange={e => setSearch(e.target.value)} />
                  </div>
                </CardHeader>
                          ...
                          {loading ? (
                            ...
                            >
                               <div className="flex justify-between items-start mb-1">
                                  <Badge className="text-[7px] md:text-[8px] px-1 md:px-2 py-0">{event.status}</Badge>
                     ...
                     {selectedEvent ? (
                       <div className="space-y-6 md:space-y-8 animate-fade-in">
                          <div className="flex items-center justify-between border-b border-white/10 pb-4">
                             <div className="min-w-0">
                                <h4 className="text-base md:text-lg font-headline italic font-bold uppercase text-accent truncate">Inspector</h4>
                             </div>
                       ...
                       <div className="h-40 md:h-full flex flex-col items-center justify-center opacity-20 text-center">
                          ...
                          <p className="text-[8px] md:text-[10px] uppercase font-bold tracking-widest">Select Node to Inspect</p>
                       </div>
                     )}
                  </div>
                </CardContent>
